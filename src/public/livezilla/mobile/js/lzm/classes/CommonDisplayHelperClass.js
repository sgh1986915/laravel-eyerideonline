...
CommonDisplayHelperClass.prototype.createButton = function(myId, myClass, myAction, myText, myIcon, myType, myCss, myTitle, myLayoutType) {
    return lzm_inputControls.createButton(myId, myClass, myAction, myText, myIcon, myType, myCss, myTitle, -1, myLayoutType);
};
...
CommonDisplayHelperClass.prototype.createInput = function(myId, myClass, myText, myLabel, myIcon, myType, myLayoutType) {
