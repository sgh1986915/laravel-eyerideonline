...
<table cellpadding="0" cellspacing="0" id="lz_form_<!--name-->" class="lz_input">
	<tr>
		...
		<td><select name="form_<!--name-->" class="lz_form_base lz_form_box lz_form_select" onchange="return parent.lz_chat_save_input_value('<!--name-->',this.selectedIndex);"><!--options--></select><div class="lz_form_info_box" id="lz_form_info_<!--name-->"><!--info_text--></div></td>
